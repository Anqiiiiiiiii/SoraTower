...
class puzzle_room(Room):
    ...
    def __init__(self, name, description, description2, answer):
...
puzzle_room_list = [
    puzzle_room(
        ...
        " and fill in the blank", '2, 5, 11, 23, 47, "blank"', "95"),
    puzzle_room(
        "math1", "Dear adventure, here is an not define intergral," +
    ...
    puzzle_room(
        "math3",
        "Dear adventure, here is a simple function, please sovlve for x",
        "x^2 - 144 = 0 and x>0", "12"),
    puzzle_room(
        "chem", "Dear adventure, please choose from following element" +
...
level_1st = starting_room(
    1, "cloudy_realm",
    "The room is filled with a sea of swirling clouds, with ethereal light filtering through, creating a dreamlike atmosphere.",
    "item"
)
level_2st = starting_room(
    2, "windy_plateau",
    "The starting room is an open terrace with strong winds whipping around, carrying the faint sounds of distant chimes.",
    "item"
)
level_3st = starting_room(
    3, "starry_sanctuary",
    "This room is illuminated by a celestial glow, with constellations twinkling on the walls and a serene, otherworldly ambiance.",
    "item"
)
level_4st = starting_room(
    4, "stormy_ascent",
    "The room is dark and turbulent, with flashes of lightning illuminating the stone walls and the sound of thunder echoing around.",
    "item"
)
level_5st = starting_room(
    5, "radiant_dawn",
    "The starting room is bathed in the golden light of a perpetual sunrise, with warm rays piercing through the translucent windows and casting long shadows.",
    "item"
)
...
final_room = ending_room(
    "crystal_room","In the center of the room stands a majestic pedestal,holding the Sky Crystal, its radiant energy pulsing gently, awaiting the touch of the one who has conquered the tower's challenges.",
    "item")
