...
# set the global statement 
calive = True
# define txt file for character for saving and write
...
npc_list = [
        npc(
                "Zepjur", 1, 0, 0, 0,
                "In the early days, our people thrived here among the clouds," 
            + "living in harmony with the winds and skies. I spent countless" 
            +  "years documenting our history, carving our stories into the" 
            + "very clouds you see around us."
        ),
        npc(
                "Gale", 1, 0, 1, 0,
                "This plateau was once the training ground for our fiercest" 
            + "warriors. I defended our kingdom from countless threats," 
            + "wielding the power of the wind to keep our enemies at bay" 
            + "and our people safe."
        ),
        npc(
                "Astra", 1, 0, 2, 0,
                "I have gazed into the cosmos from this sanctuary, reading the" 
            + "movements of the stars to guide our people. The constellations" 
            + "have long told the fate of Sora Kingdom, and I have seen both our" 
            + "rise and our fall within their patterns."
        ),
        npc(
                "Tempest", 1, 0, 3, 0,
                "I ventured through the fiercest storms of this tower, mapping" 
            + "the treacherous paths and uncovering lost relics of our ancestors." 
            + "Each thunderclap and lightning strike tells a story of resilience" 
            + "and the relentless spirit of our people."
        ),
        npc(
                "Astra", 0, 1, 4, 0,
                "In this room of perpetual dawn, I have healed many wounds and" 
            + "mended countless hearts. The light of the Radiant Dawn has always" 
            + "symbolized hope and renewal for our kingdom, guiding us through" 
            + "our darkest times and into a brighter future."
        )
]
...
def save_game():
    """
    This function allow the player save the game in side the sub menu if they 
    start a new game.
    """
    global PlayerAn
    print("\n!!!!!!!!!!!!!!!!")
...
def read_game():
    """
    Thic function allow player load the game if they have a save before
    """
    global PlayerAn
